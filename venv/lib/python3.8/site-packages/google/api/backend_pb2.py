...
_BACKENDRULE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='disable_auth', full_name='google.api.BackendRule.disable_auth', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='protocol', full_name='google.api.BackendRule.protocol', index=8,
...
_BACKENDRULE.fields_by_name['disable_auth'].containing_oneof = _BACKENDRULE.oneofs_by_name['authentication']
