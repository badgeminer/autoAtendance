...
_PHONENUMBER_SHORTCODE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='region_code', full_name='google.type.PhoneNumber.ShortCode.region_code', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='number', full_name='google.type.PhoneNumber.ShortCode.number', index=1,
...
_PHONENUMBER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='e164_number', full_name='google.type.PhoneNumber.e164_number', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='short_code', full_name='google.type.PhoneNumber.short_code', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='extension', full_name='google.type.PhoneNumber.extension', index=2,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='kind', full_name='google.type.PhoneNumber.kind',
...
_PHONENUMBER.fields_by_name['e164_number'].containing_oneof = _PHONENUMBER.oneofs_by_name['kind']
_PHONENUMBER.oneofs_by_name['kind'].fields.append(
  _PHONENUMBER.fields_by_name['short_code'])
_PHONENUMBER.fields_by_name['short_code'].containing_oneof = _PHONENUMBER.oneofs_by_name['kind']
